...
export const loginSucceeded = (session) =>
  ({ type: Types.LOGIN_SUCCEEDED, session: session })
...
export const getSessionSucceeded = (session) =>
  ({ type: Types.GET_SESSION_SUCCEEDED, session: session })
