        ...
        <div className="text-center">
          <p className="apple">
            <a href="https://itunes.apple.com/us/app/reformcow/id1099270567">
              <img src={AppleImage} alt="Download on the App Store" className="img-responsive img-fluid"></img>
            </a>
          </p>
          <p className="android">
            <a href="https://play.google.com/store/apps/details?id=com.reformcow.android">
              <img src={AndroidImage} alt="Download on Google Play" className="img-responsive img-fluid"></img>
            </a>
          </p>
        </div>
      </div>
